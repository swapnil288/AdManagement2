...
<body>
<br><br>
<h1 class="text-center">Ad Details</h1><br><br>
				...
				<div class="contact-grids1 w3agile-6">
					<div class="row">
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							...
							<input type="text" class="form-control" placeholder="Product Name" id="adTitle" name="adTitle" required="required">
							<p id="error_name"></p>
						</div>
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Details 1</label>
							<textarea class="form-control" placeholder="Product Description" id="details1" rows="3" cols="45" name="details1" required="required"></textarea>
							<p id="error_description"></p>
						</div>
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Details 2</label>
							<textarea class="form-control" placeholder="Product Description" id="details2" rows="3" cols="45" name="details2" required="required"></textarea>
							<p id="error_description"></p>
						</div>
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
